...
const ProductDetailScreen = ({ route, navigation }) => {
  ...
  try {
    ...
    // Duyệt qua danh sách yêu thích và chuyển đổi `data_product_id` thành mảng thực
    ...
    const isFav = productIds.includes(productId); // Kiểm tra xem productId có trong danh sách không
    setIsFavorite(isFav);
