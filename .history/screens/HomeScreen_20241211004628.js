...
const dummyCategories = [
  { cartegory_id: "6", cartegory_name: "Ao Quan Bong Da" },
  { cartegory_id: "7", cartegory_name: "Giay Bong Da" },
  { cartegory_id: "8", cartegory_name: "Giay The Thao" },
  { cartegory_id: "9", cartegory_name: "Ao Khoac The Thao" },
  { cartegory_id: "10", cartegory_name: "Phu Kien Khac" },
];
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity
            ...
            onPress={() => onSelectCategory(item)} // Truyền danh mục khi chọn
          >
...
const HomeScreen = () => {
  ...
  const fetchCategoryData = async () => {
    try {
      ...
      const categories = await fetchCategories(token); // Gọi API danh mục
      console.log("Categories fetched:", categories); // Log danh mục trả về từ API
  ...
  useEffect(() => {
    const initializeData = async () => {
      try {
        ...
        console.log("Final categories:", categories); // Log danh mục sau khi nhận
      } catch (error) {
