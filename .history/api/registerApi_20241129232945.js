  ...
  try {
    ...
    if (error.response && error.response.data) {
      ...
      if (error.response.data.message === 'Email already registered') {
        ...
        ToastAndroid.show('This email is already registered. Please use another email.', ToastAndroid.LONG);
      } else {
        // Các lỗi khác
      ...
      ToastAndroid.show('Network Error: Check your connection', ToastAndroid.LONG);
    } else {
      // Lỗi tổng quát
      Alert.alert('Error', error.message || 'An error occurred during registration');
      ToastAndroid.show(error.message || 'An error occurred during registration', ToastAndroid.LONG);
    }
