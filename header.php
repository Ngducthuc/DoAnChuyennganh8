...
<head>
    ...
    <link rel="stylesheet" href="../Web_Nsports/Style.css">
    <link rel="icon" type="image/x-icon" href="/image/logo12.png">
    ...
    <header id="myHeader">
        ...
        <div class="header">
                        ...
                        <li class="menu_item">
                            ...
                            <ul class="menu_sanpham">
                                ...
                                <?php foreach($categories as $cartegory_id => $cartegory_name): ?>
                                    <li>
                                        <a href="access/brand_product.php?cartegory_id=<?php echo $cartegory_id; ?>"><?php echo $cartegory_name; ?></a>
                                        <ul class="menu_con">
                                            <?php foreach($brands as $brand): ?>
                                                <?php if ($brand['cartegory_id'] == $cartegory_id): ?>
                                                    <li><a href="access/brand_product.php?cartegory_id=<?php echo $cartegory_id; ?>&brand_id=<?php echo $brand['brand_id']; ?>"><?php echo $brand['brand_name']; ?></a></li>
                                                <?php endif; ?>
                                            <?php endforeach; ?>
                                        </ul>
                                    </li>
            ...
            <div class="search" id="search">
                <form id="searchForm" action="access/index_search.php" method="GET" class="search__form">
            ...
            <script>
                ...
                <div class="icon" id="user-icon">
                    <a  <?php if(!isset($_SESSION['value'])){
                        echo 'href="access/index_login.php"';
                    }?>>
